...
public class MailUtil implements Serializable {
    ...
    public static void main(String[] args) {
        ...
        //bean.getNewEmails("imap", "mail.domain.com", "143", "sales@domain.com", "PASSWORD");
        //bean.getNewEmails("imaps", "secure195.servconfig.com", "993", "sales@domain.com", "PASSWORD");
    ...
    public IMAPMessageShowResponseModel getEmail(int messageNumber, String protocol, String host, String port, String userName, String password) {
        ...
        long diff = end - start;
        System.out.println("Found message. In [" + diff + "] millis.");
    ...
    public IMAPMessageSendResponseModel replyEmail(int messageNumber, String content, String protocol, String host, String port, String userName, String password) {
        ...
        long end = System.currentTimeMillis();
        long diff = end - start;
        System.out.println("Sent message. In [" + diff + "] millis.");
    ...
    public int getUnreadMessageCount(String protocol, String host, String port, String userName, String password) {
        try {
            Properties properties = getServerProperties(protocol, host, port);
            Session session = Session.getDefaultInstance(properties);
