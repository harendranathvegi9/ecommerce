...
public class LazySaleDataModelBySaleStatus extends LazyDataModel<SaleEntity> implements Serializable {

    private final SaleService saleService;
    private final List<SaleStatus> list;
     ...
     * @param list List
     */
    public LazySaleDataModelBySaleStatus(SaleService saleService, List<SaleStatus> list) {
    ...
    public List<SaleEntity> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        datasource = saleService.getResultList(list, first, pageSize, sortField, sortOrder, filters);
        setRowCount(saleService.count(list, filters));
        return datasource;
    }
