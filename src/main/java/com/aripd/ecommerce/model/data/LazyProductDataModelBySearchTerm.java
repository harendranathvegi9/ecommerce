...
public class LazyProductDataModelBySearchTerm extends LazyDataModel<ProductEntity> implements Serializable {
     ...
     */
    public LazyProductDataModelBySearchTerm(ProductService productService, String searchTerm) {
    ...
    public List<ProductEntity> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        datasource = productService.getResultList(searchTerm, first, pageSize, sortField, sortOrder, filters);
        setRowCount(productService.count(searchTerm, filters));
        return datasource;
    }
