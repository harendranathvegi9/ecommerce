...
public class LazyProductDataModelByCategory extends LazyDataModel<ProductEntity> implements Serializable {
     ...
     */
    public LazyProductDataModelByCategory(ProductService productService, CategoryEntity category) {
    ...
    public List<ProductEntity> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        datasource = productService.getResultList(category, first, pageSize, sortField, sortOrder, filters);
        setRowCount(productService.count(category, filters));
        return datasource;
    }
