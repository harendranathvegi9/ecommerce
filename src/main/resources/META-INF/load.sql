...
INSERT INTO `SALEENTITY` (`ID`, `COMPLETE_DATE`, `IPN_INSTALLMENTS_NUMBER`, `IPN_INSTALLMENTS_PROGRAM`, `IPN_PAID_AMOUNT`, `IPN_TOTALGENERAL`, `PAYMENTDATE`, `REFNOEXT`, `SALEDATE`, `BANKTRANSACTIONNUMBER`, `BILLCITY`, `BILLCOUNTRY`, `BILLFIRSTNAME`, `BILLLASTNAME`, `BILLLINE`, `BILLPHONE`, `BILLZIPCODE`, `CREATEDAT`, `CURRENCY`, `DELIVERYCITY`, `DELIVERYCOUNTRY`, `DELIVERYFIRSTNAME`, `DELIVERYLASTNAME`, `DELIVERYLINE`, `DELIVERYPHONE`, `DELIVERYZIPCODE`, `PAYMENTMETHOD`, `SALESTATUS`, `CREATEDBY_ID`)
VALUES
	(1,'','','',0.00,1180.00,'','20170329135953','2017-03-29 13:59:53',NULL,'il','ülke','dev','aripd','adres','5551234567','34000','2017-03-29 16:59:54','TRY','il','ülke','dev','aripd','adres','5551234567','34000','WIRE','WAITING_FOR_PAYMENT',2);

INSERT INTO `SALELINEENTITY` (`ID`, `IPN_INFO`, `IPN_PCODE`, `IPN_PID`, `IPN_PNAME`, `IPN_PRICE`, `IPN_QTY`, `IPN_TOTAL`, `IPN_VAT`, `CARGOTRACKINGLINK`, `NOTE`, `SALESTATUS`, `PRODUCT_ID`, `SALE_ID`)
VALUES
	(1,'Lorem ipsum dolor sit amet, consectetur adipiscing elit.','2000000035952','2','Lorem ipsum2',200.00,2,236.00,36.00,NULL,'paket olsun lütfen','WAITING_FOR_PAYMENT',2,1),
	(2,'Lorem ipsum dolor sit amet, consectetur adipiscing elit.','2000000035953','3','Lorem ipsum3',300.00,1,354.00,54.00,NULL,NULL,'WAITING_FOR_PAYMENT',3,1),
	(3,'Lorem ipsum dolor sit amet, consectetur adipiscing elit.','2000000035951','1','Lorem ipsum1',100.00,3,118.00,18.00,NULL,'kırmızı olanı istiyorum','WAITING_FOR_PAYMENT',1,1);
